...
MATRIX4D ViewInverse(const MATRIX4D& View)
{
	...
	VECTOR4D Pos = {
		-Dot(View.r[0],View.r[3]),
		-Dot(View.r[1],View.r[3]),
		-Dot(View.r[2],View.r[3]),
		1.0f };
	I.r[3] = Pos;
	I.m03 = 0.0f;
	I.m13 = 0.0f;
...
float Inverse(const MATRIX4D& M, MATRIX4D& R)
{
	...
	inv[0] =
		(double)M.v[5] * M.v[10] * M.v[15] -
		(double)M.v[5] * M.v[11] * M.v[14] -
		(double)M.v[9] * M.v[6] * M.v[15] +
		(double)M.v[9] * M.v[7] * M.v[14] +
		(double)M.v[13] * M.v[6] * M.v[11] -
		(double)M.v[13] * M.v[7] * M.v[10];

	inv[4] = -
		(double)M.v[4] * M.v[10] * M.v[15] +
		(double)M.v[4] * M.v[11] * M.v[14] +
		(double)M.v[8] * M.v[6] * M.v[15] -
		(double)M.v[8] * M.v[7] * M.v[14] -
		(double)M.v[12] * M.v[6] * M.v[11] +
		(double)M.v[12] * M.v[7] * M.v[10];

	inv[8] =
		(double)M.v[4] * M.v[9] * M.v[15] -
		(double)M.v[4] * M.v[11] * M.v[13] -
		(double)M.v[8] * M.v[5] * M.v[15] +
		(double)M.v[8] * M.v[7] * M.v[13] +
		(double)M.v[12] * M.v[5] * M.v[11] -
		(double)M.v[12] * M.v[7] * M.v[9];

	inv[12] = -
		(double)M.v[4] * M.v[9] * M.v[14] +
		(double)M.v[4] * M.v[10] * M.v[13] +
		(double)M.v[8] * M.v[5] * M.v[14] -
		(double)M.v[8] * M.v[6] * M.v[13] -
		(double)M.v[12] * M.v[5] * M.v[10] +
		(double)M.v[12] * M.v[6] * M.v[9];

	inv[1] = -
		(double)M.v[1] * M.v[10] * M.v[15] +
		(double)M.v[1] * M.v[11] * M.v[14] +
		(double)M.v[9] * M.v[2] * M.v[15] -
		(double)M.v[9] * M.v[3] * M.v[14] -
		(double)M.v[13] * M.v[2] * M.v[11] +
		(double)M.v[13] * M.v[3] * M.v[10];

	inv[5] =
		(double)M.v[0] * M.v[10] * M.v[15] -
		(double)M.v[0] * M.v[11] * M.v[14] -
		(double)M.v[8] * M.v[2] * M.v[15] +
		(double)M.v[8] * M.v[3] * M.v[14] +
		(double)M.v[12] * M.v[2] * M.v[11] -
		(double)M.v[12] * M.v[3] * M.v[10];

	inv[9] = -
		(double)M.v[0] * M.v[9] * M.v[15] +
		(double)M.v[0] * M.v[11] * M.v[13] +
		(double)M.v[8] * M.v[1] * M.v[15] -
		(double)M.v[8] * M.v[3] * M.v[13] -
		(double)M.v[12] * M.v[1] * M.v[11] +
		(double)M.v[12] * M.v[3] * M.v[9];

	inv[13] =
		(double)M.v[0] * M.v[9] * M.v[14] -
		(double)M.v[0] * M.v[10] * M.v[13] -
		(double)M.v[8] * M.v[1] * M.v[14] +
		(double)M.v[8] * M.v[2] * M.v[13] +
		(double)M.v[12] * M.v[1] * M.v[10] -
		(double)M.v[12] * M.v[2] * M.v[9];

	inv[2] =
		(double)M.v[1] * M.v[6] * M.v[15] -
		(double)M.v[1] * M.v[7] * M.v[14] -
		(double)M.v[5] * M.v[2] * M.v[15] +
		(double)M.v[5] * M.v[3] * M.v[14] +
		(double)M.v[13] * M.v[2] * M.v[7] -
		(double)M.v[13] * M.v[3] * M.v[6];

	inv[6] = -
		(double)M.v[0] * M.v[6] * M.v[15] +
		(double)M.v[0] * M.v[7] * M.v[14] +
		(double)M.v[4] * M.v[2] * M.v[15] -
		(double)M.v[4] * M.v[3] * M.v[14] -
		(double)M.v[12] * M.v[2] * M.v[7] +
		(double)M.v[12] * M.v[3] * M.v[6];

	inv[10] =
		(double)M.v[0] * M.v[5] * M.v[15] -
		(double)M.v[0] * M.v[7] * M.v[13] -
		(double)M.v[4] * M.v[1] * M.v[15] +
		(double)M.v[4] * M.v[3] * M.v[13] +
		(double)M.v[12] * M.v[1] * M.v[7] -
		(double)M.v[12] * M.v[3] * M.v[5];

	inv[14] = -
		(double)M.v[0] * M.v[5] * M.v[14] +
		(double)M.v[0] * M.v[6] * M.v[13] +
		(double)M.v[4] * M.v[1] * M.v[14] -
		(double)M.v[4] * M.v[2] * M.v[13] -
		(double)M.v[12] * M.v[1] * M.v[6] +
		(double)M.v[12] * M.v[2] * M.v[5];

	inv[3] = -
		(double)M.v[1] * M.v[6] * M.v[11] +
		(double)M.v[1] * M.v[7] * M.v[10] +
		(double)M.v[5] * M.v[2] * M.v[11] -
		(double)M.v[5] * M.v[3] * M.v[10] -
		(double)M.v[9] * M.v[2] * M.v[7] +
		(double)M.v[9] * M.v[3] * M.v[6];

	inv[7] =
		(double)M.v[0] * M.v[6] * M.v[11] -
		(double)M.v[0] * M.v[7] * M.v[10] -
		(double)M.v[4] * M.v[2] * M.v[11] +
		(double)M.v[4] * M.v[3] * M.v[10] +
		(double)M.v[8] * M.v[2] * M.v[7] -
		(double)M.v[8] * M.v[3] * M.v[6];

	inv[11] = -
		(double)M.v[0] * M.v[5] * M.v[11] +
		(double)M.v[0] * M.v[7] * M.v[9] +
		(double)M.v[4] * M.v[1] * M.v[11] -
		(double)M.v[4] * M.v[3] * M.v[9] -
		(double)M.v[8] * M.v[1] * M.v[7] +
		(double)M.v[8] * M.v[3] * M.v[5];

	inv[15] =
		(double)M.v[0] * M.v[5] * M.v[10] -
		(double)M.v[0] * M.v[6] * M.v[9] -
		(double)M.v[4] * M.v[1] * M.v[10] +
		(double)M.v[4] * M.v[2] * M.v[9] +
		(double)M.v[8] * M.v[1] * M.v[6] -
		(double)M.v[8] * M.v[2] * M.v[5];
...
VECTOR4D operator*(const float s, const VECTOR4D& A)
{
	return { s * A.x, s * A.y, s * A.z, s * A.w };
}
VECTOR4D operator*(const VECTOR4D& A, const float s)
{
	return s * A;
}